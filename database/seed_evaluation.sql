...
REPLACE INTO evaluation_templates (template_id, template_name, description, target_department, evaluation_type, kra_weight, behavior_weight, form_code, revision_date, effective_date_form, status, created_by) VALUES
(1, 'Digital Marketing Specialist Performance Review', 'Performance review for Digital Marketing Specialists targeting SEO, PPC, and social media campaigns.', 'Marketing', 'Annual', 80.00, 20.00, 'HRD Form-013.01', CURDATE(), '2026-06-30', 'Active', 1),
(2, 'Brand & Creative Specialist Evaluation', 'Evaluation for creative staff focusing on brand alignment, asset creation, and design.', 'Marketing', 'Annual', 80.00, 20.00, 'HRD Form-013.02', CURDATE(), '2026-06-30', 'Active', 1),
(3, 'Marketing Manager Performance Review', 'Strategic review for Marketing Managers focusing on ROI, leadership, and budget control.', 'Marketing', 'Annual', 80.00, 20.00, 'HRD Form-013.03', CURDATE(), '2026-06-30', 'Active', 1),
(4, 'General Employee Template (All Departments)', 'Standard evaluation template applicable to rank-and-file employees across all departments.', 'All Departments', 'Annual', 80.00, 20.00, 'HRD Form-013.04', CURDATE(), '2026-06-30', 'Active', 1),
(5, 'HR Specialist Performance Evaluation', 'Review template for HR Specialists focusing on recruitment, engagement, and training compliance.', 'Human Resources', 'Annual', 80.00, 20.00, 'HRD Form-013.05', CURDATE(), '2026-06-30', 'Active', 1);

REPLACE INTO evaluation_criteria (template_id, section, criterion_name, description, weight, scoring_method, sort_order) VALUES
