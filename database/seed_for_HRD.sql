...
-- =================================================================
-- Area Supervisor and Immediate Head
-- =================================================================

INSERT INTO `employees` (`employee_id`, `employee_code`, `first_name`, `last_name`, `middle_name`, `date_of_birth`, `place_of_birth`, `gender`, `civil_status`, `hire_date`, `job_title`, `job_title_id`, `rank_category_id`, `department_id`, `branch_id`, `employment_status`, `employment_type`, `profile_picture`, `is_active`, `created_at`, `updated_at`) VALUES
(5, '026-004', 'John', 'Doe', 'Jr.', '1990-01-01', 'Quezon City', 'Male', 'Single', '2020-01-01', 'Area Supervisor I', 61, 4, 9, 102, 'Regular', 'Full-time', 'john_doe.jpg', 1, NOW(), NOW());

INSERT INTO `employee_contacts` (`employee_id`, `mobile_number`, `personal_email`) VALUES
(5, '09171112222', 'john.doe@example.com');

INSERT INTO `employee_addresses` (`employee_id`, `address_type`, `house_no`, `street`, `subdivision`, `barangay`, `city`, `province`, `zip_code`) VALUES
(5, 'Residential', '123', 'Main St', 'Sampaguita', 'Barangay Maligaya', 'Quezon City', 'Metro Manila', '1100'),
(5, 'Permanent', '123', 'Main St', 'Sampaguita', 'Barangay Maligaya', 'Quezon City', 'Metro Manila', '1100');

INSERT INTO `employee_details` (`employee_id`, `height_m`, `weight_kg`, `blood_type`, `citizenship`) VALUES
(5, 1.75, 70.00, 'A+', 'Filipino');

INSERT INTO `employee_family` (`employee_id`, `member_type`, `surname`, `first_name`, `middle_name`, `occupation`) VALUES
(5, 'Father', 'Doe', 'John', 'Sr.', 'Engineer'),
(5, 'Mother', 'Smith', 'Jane', 'Marie', 'Housewife');

INSERT INTO `employee_children` (`employee_id`, `surname`, `first_name`, `middle_name`, `date_of_birth`) VALUES
(5, 'Doe', 'Jane', 'Marie', '2015-05-05');

INSERT INTO `employee_siblings` (`employee_id`, `surname`, `first_name`, `middle_name`, `date_of_birth`) VALUES
(5, 'Doe', 'Mary', 'Jane', '1992-03-15');

INSERT INTO `employee_education` (`employee_id`, `education_level`, `school_name`, `degree_course`, `period_from`, `period_to`, `highest_level_units`, `year_graduated`, `honors_received`) VALUES
(5, 'Elementary', 'St. Peter Academy', NULL, '1994-06-01', '2000-03-31', 'Graduated', '2000', NULL),
(5, 'Secondary', 'Quezon City High School', NULL, '2000-06-01', '2004-03-31', 'Graduated', '2004', NULL),
(5, 'College', 'Ateneo de Manila University', 'BS Business Management', '2004-06-01', '2008-03-31', 'Graduated', '2008', 'With Honors');

INSERT INTO `employee_work_experience` (`employee_id`, `date_from`, `date_to`, `job_title`, `company_name`, `monthly_salary`, `appointment_status`, `reason_for_leaving`) VALUES
(5, '2012-06-01', '2018-12-31', 'Recruitment Associate', 'Prime Solutions Inc.', 32000.00, 'Full-time', 'Better opportunity'),
(5, '2019-01-01', '2023-12-31', 'Operations Lead', 'FastTrack Logistics', 45000.00, 'Full-time', 'Career advancement');

INSERT INTO `employee_trainings` (`employee_id`, `date_from`, `date_to`, `training_title`, `training_type`, `no_of_hours`, `conducted_by`) VALUES
(5, '2021-03-10', '2021-03-12', 'Advanced Supervisory Skills', 'Management', 24, 'Civil Service Commission'),
(5, '2022-07-15', '2022-07-17', 'Logistics and Route Optimization', 'Technical', 16, 'Logistics Institute');

INSERT INTO `employee_eligibility` (`employee_id`, `license_title`, `license_number`, `date_of_exam`, `place_of_exam`) VALUES
(5, 'Civil Service Professional', 'CS-2010-098765', '2010-08-15', 'Quezon City');

INSERT INTO `employee_skills` (`employee_id`, `skill_name`) VALUES
(5, 'Fleet Management'), (5, 'Route Optimization'), (5, 'Team Leadership'), (5, 'Strategic Planning');

INSERT INTO `employee_government_ids` (`employee_id`, `sss_number`, `philhealth_number`, `pagibig_number`, `tin_number`) VALUES
(5, '34-1234567-8', '12-987654321-0', '1212-3434-5656', '987-654-321-001');

INSERT INTO `employee_disclosures` (`employee_id`, `is_related_to_company`, `has_admin_offense`, `has_criminal_charge`, `has_criminal_conviction`, `has_been_separated`, `is_pwd`, `is_solo_parent`, `has_recent_hospital`, `has_current_treatment`) VALUES
(5, 0, 0, 0, 0, 0, 0, 0, 0, 0);

INSERT INTO `employee_emergency_contacts` (`employee_id`, `contact_name`, `relationship`, `contact_number`) VALUES
(5, 'Jane Smith Doe', 'Spouse', '09172223333');

-- ---------------------------------------------------------
-- EMPLOYEE 5: Richard Miles (Immediate Head)
-- ---------------------------------------------------------
INSERT INTO `employees` (`employee_id`, `employee_code`, `first_name`, `last_name`, `middle_name`, `date_of_birth`, `place_of_birth`, `gender`, `civil_status`, `hire_date`, `job_title`, `job_title_id`, `rank_category_id`, `department_id`, `branch_id`, `employment_status`, `employment_type`, `profile_picture`, `is_active`, `created_at`, `updated_at`) VALUES
(6, '026-006', 'Richard', 'Miles', 'Foster', '1982-11-20', 'Manila', 'Male', 'Married', '2015-05-15', 'Immediate Head', 269, 3, 9, 102, 'Regular', 'Full-time', NULL, 1, NOW(), NOW());

INSERT INTO `employee_contacts` (`employee_id`, `mobile_number`, `personal_email`) VALUES
(6, '09185554433', 'richard.miles@raquelhris.com');

INSERT INTO `employee_addresses` (`employee_id`, `address_type`, `house_no`, `street`, `barangay`, `city`, `province`, `zip_code`) VALUES
(6, 'Residential', '78', 'Oak Drive', 'Green Village', 'Makati City', 'Metro Manila', '1200'),
(6, 'Permanent', '78', 'Oak Drive', 'Green Village', 'Makati City', 'Metro Manila', '1200');

INSERT INTO `employee_details` (`employee_id`, `height_m`, `weight_kg`, `blood_type`, `citizenship`) VALUES
(6, 1.80, 80.00, 'B+', 'Filipino');

INSERT INTO `employee_family` (`employee_id`, `member_type`, `surname`, `first_name`, `middle_name`, `occupation`) VALUES
(6, 'Spouse', 'Miles', 'Sarah', 'L.', 'Bank Manager'),
(6, 'Father', 'Miles', 'Arthur', 'P.', 'Retired'),
(6, 'Mother', 'Foster', 'Elizabeth', 'G.', 'Retired');

INSERT INTO `employee_education` (`employee_id`, `education_level`, `school_name`, `degree_course`, `period_from`, `period_to`, `highest_level_units`, `year_graduated`) VALUES
(6, 'College', 'De La Salle University', 'BS Industrial Engineering', '1999-06-01', '2003-03-31', 'Graduated', '2003'),
(6, 'Graduate Studies', 'Asian Institute of Management', 'MBA', '2008-06-01', '2010-03-31', 'Graduated', '2010');

INSERT INTO `employee_work_experience` (`employee_id`, `date_from`, `date_to`, `job_title`, `company_name`, `monthly_salary`, `appointment_status`) VALUES
(6, '2003-06-01', '2010-12-31', 'Supply Chain Analyst', 'Global Logistics', 35000.00, 'Full-time'),
(6, '2011-01-01', '2015-04-30', 'Operations Manager', 'Metro Distribution', 75000.00, 'Full-time');

INSERT INTO `employee_skills` (`employee_id`, `skill_name`) VALUES
(6, 'Operations Management'), (6, 'Supply Chain Optimization'), (6, 'Leadership'), (6, 'Budgeting');

INSERT INTO `employee_government_ids` (`employee_id`, `sss_number`, `philhealth_number`, `pagibig_number`, `tin_number`) VALUES
(6, '03-1234567-9', '11-223344556-7', '1010-2020-3030', '123-456-789-002');

INSERT INTO `employee_emergency_contacts` (`employee_id`, `contact_name`, `relationship`, `contact_number`) VALUES
(6, 'Sarah Miles', 'Spouse', '09185551122');

INSERT INTO `users` (`user_id`, `employee_id`, `username`, `email`, `password_hash`, `full_name`, `role`, `branch_id`, `is_active`, `first_login_completed`, `created_at`, `updated_at`) VALUES
(6, 6, 'richard.miles', 'richard.miles@raquelhris.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Richard Miles', 'Manager', 102, 1, 1, NOW(), NOW());

-- ---------------------------------------------------------
-- EMPLOYEE 6: Pedro Penduko (Cashier - Laurel Branch)
-- ---------------------------------------------------------
INSERT INTO `employees` (`employee_id`, `employee_code`, `first_name`, `last_name`, `middle_name`, `date_of_birth`, `place_of_birth`, `gender`, `civil_status`, `hire_date`, `job_title`, `job_title_id`, `rank_category_id`, `department_id`, `branch_id`, `employment_status`, `employment_type`, `profile_picture`, `is_active`, `created_at`, `updated_at`) VALUES
(7, '026-007', 'Pedro', 'Penduko', 'Cruz', '1995-08-12', 'Laurel, Batangas', 'Male', 'Single', '2022-03-01', 'Cashier', 270, 5, 5, 85, 'Regular', 'Full-time', NULL, 1, NOW(), NOW());

INSERT INTO `employee_contacts` (`employee_id`, `mobile_number`, `personal_email`) VALUES
(7, '09201112233', 'pedro.penduko@example.com');

INSERT INTO `employee_addresses` (`employee_id`, `address_type`, `house_no`, `street`, `barangay`, `city`, `province`, `zip_code`) VALUES
(7, 'Residential', '12', 'Mabini St.', 'Poblacion Tres', 'Laurel', 'Batangas', '4221'),
(7, 'Permanent', '12', 'Mabini St.', 'Poblacion Tres', 'Laurel', 'Batangas', '4221');

INSERT INTO `employee_details` (`employee_id`, `height_m`, `weight_kg`, `blood_type`, `citizenship`) VALUES
(7, 1.70, 65.00, 'O+', 'Filipino');

INSERT INTO `employee_family` (`employee_id`, `member_type`, `surname`, `first_name`, `middle_name`, `occupation`) VALUES
(7, 'Father', 'Penduko', 'Juan', 'D.', 'Farmer'),
(7, 'Mother', 'Cruz', 'Maria', 'S.', 'Vendor');

INSERT INTO `employee_education` (`employee_id`, `education_level`, `school_name`, `degree_course`, `period_from`, `period_to`, `highest_level_units`, `year_graduated`) VALUES
(7, 'Secondary', 'Laurel National High School', NULL, '2008-06-01', '2012-03-31', 'Graduated', '2012'),
(7, 'College', 'Batangas State University', 'BS Business Administration', '2012-06-01', '2016-03-31', 'Graduated', '2016');

INSERT INTO `employee_work_experience` (`employee_id`, `date_from`, `date_to`, `job_title`, `company_name`, `monthly_salary`, `appointment_status`) VALUES
(7, '2017-01-01', '2021-12-31', 'Sales Clerk', 'Local General Store', 12000.00, 'Full-time');

INSERT INTO `employee_skills` (`employee_id`, `skill_name`) VALUES
(7, 'Customer Service'), (7, 'Cash Handling'), (7, 'Inventory Management');

INSERT INTO `employee_government_ids` (`employee_id`, `sss_number`, `philhealth_number`, `pagibig_number`, `tin_number`) VALUES
(7, '04-9876543-2', '12-334455667-8', '2020-1010-4040', '321-654-987-003');

INSERT INTO `employee_emergency_contacts` (`employee_id`, `contact_name`, `relationship`, `contact_number`) VALUES
(7, 'Maria Cruz', 'Mother', '09205559988');

INSERT INTO `users` (`user_id`, `employee_id`, `username`, `email`, `password_hash`, `full_name`, `role`, `branch_id`, `is_active`, `first_login_completed`, `created_at`, `updated_at`) VALUES
(7, 7, 'pedro.penduko', 'pedro.penduko@example.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Pedro Penduko', 'Employee', 4, 1, 1, NOW(), NOW());
