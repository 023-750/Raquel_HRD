...
$pds_sections = [
    ...
    'Permanent Address' => ['Permanent House No', 'Permanent Street', 'Permanent Subdivision', 'Permanent Barangay', 'Permanent City', 'Permanent Province', 'Permanent Zip Code', 'Residential House No', 'Residential Street', 'Residential Subdivision', 'Residential Barangay', 'Residential City', 'Residential Province', 'Residential Zip Code'],
    ...
    'Employment Details' => ['Company ID', 'Hire Date', 'Job Title', 'Department', 'Branch', 'Employment Status', 'Employment Type', 'Previous Company 1', 'Previous Position 1', 'Previous Monthly Salary 1', 'Previous Employment Period 1', 'Previous Reason for Leaving 1', 'Training Title 1', 'Training Conducted By 1', 'Training Hours 1'],
...
$sample = [
    ...
    'Permanent House No' => '123', 'Permanent Street' => 'Rizal Street', 'Permanent Subdivision' => 'Villa Flora', 'Permanent Barangay' => 'Barangay 1', 'Permanent City' => 'Calamba', 'Permanent Province' => 'Laguna', 'Permanent Zip Code' => '4027',
    'Residential House No' => '123', 'Residential Street' => 'Rizal Street', 'Residential Subdivision' => 'Villa Flora', 'Residential Barangay' => 'Barangay 1', 'Residential City' => 'Calamba', 'Residential Province' => 'Laguna', 'Residential Zip Code' => '4027',
    ...
    'Company ID' => 'EMP-2026-0001', 'Hire Date' => '05/27/2026', 'Job Title' => 'IT Supervisor', 'Department' => 'Information Technology', 'Branch' => 'Raquel Pawnshop Main Office', 'Employment Status' => 'Regular', 'Employment Type' => 'Full-time',
