...
if ($filter_search !== '') {
    $like = '%' . $filter_search . '%';
    $where .= " AND (et.template_name LIKE ? OR et.description LIKE ? OR et.form_code LIKE ?)";
    $types .= "sss";
...
<div class="supervisor-template-page">
    <div class="page-hero fadeup">
        ...
        <p class="text-white-50 small mb-0"><i class="fas fa-eye me-1"></i>Browse active evaluation templates, criteria, scoring methods, and target departments.</p>
    ...
    <div class="template-filter-card fadeup fadeup-1">
        <form method="GET" action="" class="row g-3 align-items-end">
            <div class="col-lg-7 col-md-6">
                ...
                <input type="search" class="form-control form-control-sm" name="q" value="<?php echo e($filter_search); ?>" placeholder="Template name, form code, description">
            </div>
    ...
    <?php else: ?>
        <div class="row g-4 fadeup fadeup-2">
            <?php foreach ($templates as $template): ?>
                ...
                $target_dept = $template['target_department'] ?: 'All Departments';
                        ...
                        <div class="card-body p-4">
                            <div class="d-flex justify-content-between align-items-start gap-3 mb-3">
                                ...
                                <div class="d-flex flex-wrap gap-1 justify-content-end">
                                    ...
                                    <?php if (!empty($template['target_department'])): ?>
                                        <span class="badge bg-success-subtle text-success border border-success-subtle"><?php echo e($template['target_department']); ?></span>
                                    <?php endif; ?>
                                </div>
                            </div>
                            ...
                            <div class="row g-2 mb-3">
                                <div class="col-6">
                                    <div class="small text-muted mb-1">Target Department</div>
                                    <div class="small fw-bold"><i class="fas fa-building me-1 text-primary"></i><?php echo e($target_dept); ?></div>
                                </div>
                                <div class="col-6">
